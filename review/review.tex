...
A linear SVM is used to diagnose AD vs controls (cohorts I,II and III) and AD (cohort II) vs FTLD (cohort IV). In all cases, classification accuracy is very high, reaching 96\% in some tests. Diagnosis accuracy is also high for mild-AD vs controls (88.9\%), in line with the diagnosis rates of the best clinical centers around the world. \cite{knopman2001practice} Authors have also tried using different datasets for training and testing, and again the observed accuracy is very high (87.5\% and 96.4\%), suggesting that the method is robust and can be generalised across multiple scanners. 
